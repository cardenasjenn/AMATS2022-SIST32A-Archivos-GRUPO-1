    ...
    <div class="container" id="main">
            <table class="table table-bordered table-hover">
                  ...
                  <tbody>
                    ...
                    ?>
                        <tr>
                            <td colspan="7">NO HAY SERVICIOS EN EL CARRITO</td>
            ...
            <div class="row">
                    <div class="pull-left">
                        <a href="index.php" class="btn btn-info">Adquirir otro servicios</a>
                    </div>
                    <div class="pull-right">
                        <a href="finalizar.php" class="btn btn-success">Finalizar Adquisicion</a>
                    </div>
            </div>
